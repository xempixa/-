...
$web = Start-Process powershell -ArgumentList "-File .\scripts\run_web.ps1" -PassThru
$worker = Start-Process powershell -ArgumentList "-File .\scripts\run_worker_loop.ps1" -PassThru
$scheduler = Start-Process powershell -ArgumentList "-File .\scripts\run_scheduler_loop.ps1" -PassThru
